...
- [Формат POST-запросов](#Формат-POST-запросов)
...
Предполагается использование ОС Linux (Ubuntu 16.04+). Необходимо склонировать ветку [deploy](https://github.com/Goshabur/RestaurantBES/tree/deploy). Все последующие действия выполнять из той же директории, в которую было произведено клонирование.
