...
Rectangle {
    ...
    property int position: Qt.RightEdge  // Положение Navigation Drawer - Слева/Справа
    ...
    readonly property int _slideDuration: 500
...
//    (Screen.width > Screen.height) ? dp(250) : Screen.width - dp(56)
